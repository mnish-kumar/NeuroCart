...
describe('PATCH /api/cart/items/:productId', () => {
  ...
  test('returns 400 when productId param is invalid', async () => {
  ...
  test('updates qty when item exists in cart', async () => {
    ...
    expect(res.body).toMatchObject({ message: 'Cart item updated successfully' });
